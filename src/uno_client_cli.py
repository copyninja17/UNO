...
CLI client for uno.
Cards and options are entered by typing their index.
'''
...
class Client:
    ...
    def __init__(self):
        ...
        self.choice = 0
        self.colour = '0'
        self.event = ['0', 'regular', 'no_cards',
                      '+4/+2', 'reverse', 'skip', 'wild']
...
while True:
    ...
    # data received
    top_card, player_hand, eventID, drawn_cards, playerTurn, winner, chosenColour = client.parse(
        data)
        ...
        if client.event[eventID] == 'regular':
            ...
            while True:
                ...
                if played_card > 0 and played_card <= len(playable_cards.stack):
                    print(
                        f"Card played: {playable_cards.stack[played_card-1].show()}")
                    ...
                    print(
                        f"Please enter a number between 1 and {len(playable_cards.stack)}")
